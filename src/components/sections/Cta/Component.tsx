...
export function Cta({ theme = "white", layout = "center", title, lead, buttons }: CtaData) {
  return (
    <Card theme={theme} padding="none" className={cx(styles.card, layout === "split" ? styles.split : styles.center)}>
